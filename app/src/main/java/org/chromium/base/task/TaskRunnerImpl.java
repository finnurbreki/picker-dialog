...
public class TaskRunnerImpl implements TaskRunner {
    ...
    protected Boolean belongsToCurrentThreadInternal() {
        ...
        return null; // TaskRunnerImplJni.get().belongsToCurrentThread(mNativeTaskRunnerAndroid);
    }
    ...
    /* package */ void initNativeTaskRunner() {
        long nativeTaskRunnerAndroid = 0; /* TaskRunnerImplJni.get().init(mTaskRunnerType,
